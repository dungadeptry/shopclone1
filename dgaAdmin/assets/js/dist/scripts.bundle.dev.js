  ...
  if (e) {
    var i = {
      ...
      var e,
          ...
          r = m("wrappers"),
          o = m("offset");
      if ((t -= c(n.element), null !== i) && (e = document.querySelectorAll(i)) && e.length > 0) for (var a = 0, l = e.length; a < l; a++) {
  ...
  if (null != e) {
    var r = {
      ...
      if (null !== r && KTUtil.css(n.element, "right", r), null !== l) {
        ...
        if (p && p.length > 0) for (var g = 0, v = p.length; g < v; g++) {
...
var KTSwapper = function KTSwapper(e, t) {
  var n = this;
...
var KTApp = function () {
  var e = !1,
      t = function t(e, _t2) {
    var n = {};
    e.hasAttribute("data-bs-delay-hide") && (n.hide = e.getAttribute("data-bs-delay-hide")), e.hasAttribute("data-bs-delay-show") && (n.show = e.getAttribute("data-bs-delay-show")), n && (_t2.delay = n), e.hasAttribute("data-bs-dismiss") && "click" == e.getAttribute("data-bs-dismiss") && (_t2.dismiss = "click");
    var i = new bootstrap.Tooltip(e, _t2);
    return _t2.dismiss && "click" === _t2.dismiss && e.addEventListener("click", function (e) {
      i.hide();
    }), i;
  },
      n = function n(e, t) {
  ...
  return {
    ...
    initBootstrapTooltip: function initBootstrapTooltip(e, n) {
      return t(e, n);
    },
    ...
    initBootstrapModal: function initBootstrapModal() {
      -1 !== navigator.userAgent.toLowerCase().indexOf("firefox") && document.querySelectorAll(".modal:not(.initialized)").forEach(function (e) {
    ...
    initBootstrapPopover: function initBootstrapPopover(e, t) {
      return n(e, t);
    },
    ...
    setThemeMode: function setThemeMode(e, t) {
      !function (e, t) {
        var n = function n(e, t) {
