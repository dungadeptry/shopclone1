...
! function() { "use strict";
        ...
        r = function() {
            function e() {! function(e, a) { if (!(e instanceof a)) throw new TypeError("Cannot call a class as a function") }(this, e) } var r, l; return r = e, null, (l = [{ key: "run", value: function(e) { var a = this,
                    ...
                    jQuery(".js-sparkline:not(.js-sparkline-enabled)").each((function(a, t) { var r = jQuery(t),
                        ...
                        t.addClass("js-pw-strength-enabled").pwstrength({ ui: { container: o, viewports: { progress: n, verdict: r } } }) })) } }, { key: "flatpickr", value: function(e) {
    ...
    function d(e, a) { return !a || "object" !== i(a) && "function" != typeof a ? function(e) { if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return e }(e) : a }

    function c(e) { return (c = Object.setPrototypeOf ? Object.getPrototypeOf : function(e) { return e.__proto__ || Object.getPrototypeOf(e) })(e) } var u = function(e) {! function(e, a) { if ("function" != typeof a && null !== a) throw new TypeError("Super expression must either be null or a function");
            e.prototype = Object.create(a && a.prototype, { constructor: { value: e, writable: !0, configurable: !0 } }), a && s(e, a) }(n, e); var a, t, o = (a = n, t = function() { if ("undefined" == typeof Reflect || !Reflect.construct) return !1; if (Reflect.construct.sham) return !1; if ("function" == typeof Proxy) return !0; try { return Date.prototype.toString.call(Reflect.construct(Date, [], (function() {}))), !0 } catch (e) { return !1 } }(), function() { var e, o = c(a); if (t) { var n = c(this).constructor;
                e = Reflect.construct(o, arguments, n) } else e = o.apply(this, arguments); return d(this, e) });
        ...
        function e() {! function(e, a) { if (!(e instanceof a)) throw new TypeError("Cannot call a class as a function") }(this, e), this._uiInit() } var t, o; return t = e, (o = [{ key: "_uiInit", value: function() { this._lHtml = jQuery("html"), this._lBody = jQuery("body"), this._lpageLoader = jQuery("#page-loader"), this._lPage = jQuery("#page-container"), this._lSidebar = jQuery("#sidebar"), this._lSidebarScrollCon = jQuery(".js-sidebar-scroll", "#sidebar"), this._lSideOverlay = jQuery("#side-overlay"), this._lHeader = jQuery("#page-header"), this._lHeaderSearch = jQuery("#page-header-search"), this._lHeaderSearchInput = jQuery("#page-header-search-input"), this._lHeaderLoader = jQuery("#page-header-loader"), this._lMain = jQuery("#main-container"), this._lFooter = jQuery("#page-footer"), this._lSidebarScroll = !1, this._lSideOverlayScroll = !1, this._windowW = a.getWidth(), this._uiHandleSidebars("init"), this._uiHandleHeader(), this._uiHandleNav(), this._uiHandleTheme(), this._uiApiLayout(), this._uiApiBlocks(), this.helpers(["core-bootstrap-tooltip", "core-bootstrap-popover", "core-bootstrap-tabs", "core-bootstrap-custom-file-input", "core-toggle-class", "core-scroll-to", "core-year-copy", "core-appear", "core-ripple"]), this._uiHandlePageLoader() } }, { key: "_uiHandleSidebars", value: function(e) { var a = this; "init" === e ? (a._lPage.addClass("side-trans-enabled"), this._uiHandleSidebars()) : a._lPage.hasClass("side-scroll") ? (a._lSidebar.length > 0 && !a._lSidebarScroll && (a._lSidebarScroll = new SimpleBar(a._lSidebarScrollCon[0]), jQuery(".simplebar-content-wrapper", a._lSidebar).scrollLock("enable")), a._lSideOverlay.length > 0 && !a._lSideOverlayScroll && (a._lSideOverlayScroll = new SimpleBar(a._lSideOverlay[0]), jQuery(".simplebar-content-wrapper", a._lSideOverlay).scrollLock("enable"))) : (a._lSidebar && a._lSidebarScroll && (jQuery(".simplebar-content-wrapper", a._lSidebar).scrollLock("disable"), a._lSidebarScroll.unMount(), a._lSidebarScroll = null, a._lSidebarScrollCon.removeAttr("data-simplebar").html(jQuery(".simplebar-content", a._lSidebar).html())), a._lSideOverlay && a._lSideOverlayScroll && (jQuery(".simplebar-content-wrapper", a._lSideOverlay).scrollLock("disable"), a._lSideOverlayScroll.unMount(), a._lSideOverlayScroll = null, a._lSideOverlay.removeAttr("data-simplebar").html(jQuery(".simplebar-content", a._lSideOverlay).html()))) } }, { key: "_uiHandleHeader", value: function() { var e = this;
                jQuery(window).off("scroll.pixelcave.header"), e._lPage.hasClass("page-header-glass") && e._lPage.hasClass("page-header-fixed") && jQuery(window).on("scroll.pixelcave.header", (function(a) { jQuery(a.currentTarget).scrollTop() > 60 ? e._lPage.addClass("page-header-scroll") : e._lPage.removeClass("page-header-scroll") })).trigger("scroll.pixelcave.header") } }, { key: "_uiHandleNav", value: function() { this._lPage.off("click.pixelcave.menu"), this._lPage.on("click.pixelcave.menu", '[data-toggle="submenu"]', (function(e) { var t = jQuery(e.currentTarget); if (!(a.getWidth() > 991 && t.parents(".nav-main").hasClass("nav-main-horizontal nav-main-hover"))) { var o = t.parent("li");
                        o.hasClass("open") ? (o.removeClass("open"), t.attr("aria-expanded", "false")) : (t.closest("ul").children("li").removeClass("open"), o.addClass("open"), t.attr("aria-expanded", "true")), t.trigger("blur") } return !1 })) } }, { key: "_uiHandlePageLoader", value: function() { var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "hide",
                    a = arguments.length > 1 ? arguments[1] : void 0; "show" === e ? this._lpageLoader.length ? (a && this._lpageLoader.removeClass().addClass(a), this._lpageLoader.addClass("show")) : this._lBody.prepend('<div id="page-loader" class="show'.concat(a ? " " + a : "", '"></div>')) : "hide" === e && this._lpageLoader.length && this._lpageLoader.removeClass("show") } }, { key: "_uiHandleTheme", value: function() { var e = jQuery("#css-theme"),
                    t = !!this._lPage.hasClass("enable-cookies"); if (t) { var o = Cookies.get("dashmixThemeName") || !1;
                ...
                jQuery('[data-toggle="theme"][data-theme="' + (e.length ? e.attr("href") : "default") + '"]').addClass("active"), this._lPage.off("click.pixelcave.themes"), this._lPage.on("click.pixelcave.themes", '[data-toggle="theme"]', (function(o) { o.preventDefault(); var n = jQuery(o.currentTarget),
                        r = n.data("theme");
                    jQuery('[data-toggle="theme"]').removeClass("active"), jQuery('[data-toggle="theme"][data-theme="' + r + '"]').addClass("active"), a.updateTheme(e, r), e = jQuery("#css-theme"), t && Cookies.set("dashmixThemeName", r, { expires: 7 }), n.trigger("blur") })) } }, { key: "_uiApiLayout", value: function() { var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "init",
                    t = this;
